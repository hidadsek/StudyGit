...
public class RegisterPageObjextInit extends BasePage {
	private WebDriver driver;
	
	public RegisterPageObjextInit(WebDriver driver) {
		this.driver = driver;
	}
	...
	public HomePageObjectInit clickLogOutLink() {
		waitForElementClickable(driver, HomePageUI.LOGOUT_LINK);
		clickElement(driver, HomePageUI.LOGOUT_LINK);
		return new HomePageObjectInit(driver);
	}
}
